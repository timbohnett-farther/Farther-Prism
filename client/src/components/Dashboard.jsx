...
const Dashboard = () => {
  ...
  const tools = [
    ...
    },
    {
      ...
      description: 'Private equity, real estate, hedge funds, and venture capital',
      icon: '🚀',
      route: '/alternatives',
      status: 'active',
      features: [
        '5 Farther-managed alternative funds',
        'Suitability checks and allocation tracking',
        'Due diligence scores for all opportunities',
      ],
    },
  ];
